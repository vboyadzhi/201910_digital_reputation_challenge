...
def build_docs():
    ...
    python_call(
        "ipykernel", ["install", "--user", "--name=digital_reputation_challenge"]
    )
    ...
    call(
        [
            ...
            "-o",
            "docs/source",
            "src/digital_reputation_challenge",
        ]
    )
...
def convert_notebook(all_flag, overwrite_flag, filepath):
    ...
    *Note*: Make sure your notebooks have unique names!
    ...
    """
    from digital_reputation_challenge.run import ProjectContext
    ...
    kedro_package_name = "digital_reputation_challenge"
